...
const StudentAttendanceScreen = () => {
  ...
  // Status colors are reactive (use BRAND from hook alias)
          ...
          <View style={s.overviewInner}>
            ...
            <View style={s.statsRow}>
              {[
                ...
                <View key={stat.label} style={[s.statChip, { backgroundColor: stat.color + '18', borderColor: stat.color + '44' }]}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={s.monthScroll} contentContainerStyle={s.monthContent}>
          {months.map((month, index) => {
            ...
            return (
              <TouchableOpacity
                key={month}
                style={[s.monthChip, active ? { backgroundColor: BRAND.teal, borderColor: BRAND.teal } : { backgroundColor: BRAND.surface, borderColor: BRAND.border }]}
