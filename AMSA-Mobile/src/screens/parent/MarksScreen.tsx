...
const makeStyles = (colors: BrandPalette) => StyleSheet.create({
  ...
  childAvatar:     { width: 40, height: 40, borderRadius: 20, overflow: 'hidden' },
  childAvatarText: { fontSize: 15, fontWeight: '800', color: '#fff' },
  childNameText:   { fontSize: 18, fontWeight: '700', color: colors.textPrimary, letterSpacing: -0.3 },
  ...
  subjectName:   { fontSize: 17, fontWeight: '700', color: colors.textPrimary, letterSpacing: -0.3, flex: 1 },
  ...
  scoreTotal:    { fontSize: 17, color: colors.textSecondary, marginLeft: 4, marginBottom: 6 },
  progressTrack: { height: 5, backgroundColor: colors.border, borderRadius: 3, overflow: 'hidden', marginHorizontal: 16, marginBottom: 12 },
  progressFill:  { height: '100%', borderRadius: 3 },

  testsWrap:     { backgroundColor: colors.surfaceAlt, borderRadius: 12, overflow: 'hidden', marginHorizontal: 12, marginBottom: 12 },
